...
//print("tickets left: blue: "+this.get_s16("blueTickets")+" red: "+this.get_s16("redTickets"));
		if(teamNum==1){					//if one team is dead, other wins (no consideration for more teams)
			...
			this.SetGlobalMessage( this.getTeam(0).getName() + " wins the game by killing all enemies!" );
			return true;
		}else if(teamNum==0){
			...
			this.SetCurrentState(GAME_OVER);
			this.SetGlobalMessage( this.getTeam(1).getName() + " wins the game by killing all enemies!" );
			return true;
		}
