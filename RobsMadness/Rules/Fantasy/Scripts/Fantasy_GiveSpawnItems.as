...
bool SetMaterials(CBlob@ blob,  const string &in name, const int quantity)
{
        ...
        if (mat !is null)
        {
				...
				if(mat.getName() == "minimine"){
					mat.server_setTeamNum(blob.getTeamNum());
					mat.SetDamageOwnerPlayer(blob.getPlayer());
				}
...
bool GiveSpawnResources(CRules@ this, CBlob@ blob, CPlayer@ player, CTFPlayerInfo@ info)
{
        ...
        if (blob.getName() == "builder" || blob.getName() == "runemaster")
        {
                if (this.isWarmup())
                {
        ...
        else if (blob.getName() == "ranger" || blob.getName() == "crossbow")
        {
        ...
        {
                ret = SetMaterials(blob, "minimine", 10) || ret;
...
bool canGetSpawnmats(CRules@ this, CPlayer@ p, RulesCore@ core)
{
        ...
        else //trying to get new class items, give a guy a break
        {
                ...
                else if (name == "archer" || name == "crossbow")
