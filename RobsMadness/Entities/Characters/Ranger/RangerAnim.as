...
void onTick(CSprite@ this)
{
	...
	else if (firing || legolas)
	{
		if(blob.get_u8("weapon") == 0){
			...
			if(!this.isAnimation("stab"))this.SetAnimation("stab");
		}
	}
	else if (inair)
	{
	...
	if (firing || legolas)
	{
		...
		if(blob.get_u8("weapon") == 0)DrawBow(this, blob, archer, armangle, arrowType, armOffset);
	}
	else
	{
