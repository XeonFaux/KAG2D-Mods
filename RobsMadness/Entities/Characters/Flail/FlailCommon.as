...
{
	const ::s32 resheath_time = 8;
	const ::s32 slash_charge_level2 = 20;
	const ::s32 slash_charge = 20;
	const ::s32 slash_charge_limit = slash_charge_level2 + slash_charge + 200;
	const ::s32 slash_move_time = 5;
	const ::s32 slash_time = 13;
	const ::s32 double_slash_time = 5;

	const ::f32 slash_move_max_speed = 4.5f;

	const u32 glide_down_time = 54;
}
...
const f32 DEFAULT_ATTACK_DISTANCE = 22.0f;
const f32 MAX_ATTACK_DISTANCE = 25.0f;
const f32 SHIELD_KNOCK_VELOCITY = 8.0f;

const f32 SHIELD_BLOCK_ANGLE = 185.0f;
