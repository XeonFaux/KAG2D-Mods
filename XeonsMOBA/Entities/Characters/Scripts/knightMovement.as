...
void onTick(CMovement@ this)
{
	...
	bool left_or_right = (left || right);
	{
		...
		if(blob.get_u8("spd") == 1)
		{
			const f32 turnaroundspeed = 1.5f;
			const f32 normalspeed = 1.2f;
			const f32 backwardsspeed = 1.0f;
		}
		 
		else if(blob.get_u8("spd") == 2)
		{
			const f32 turnaroundspeed = 1.6f;
			const f32 normalspeed = 1.4f;
			const f32 backwardsspeed = 1.2f;
		}
		else if(blob.get_u8("spd") == 3)
		{
			const f32 turnaroundspeed = 1.6f;
			const f32 normalspeed = 1.6f;
			const f32 backwardsspeed = 1.4f;
		}
		else if(blob.get_u8("spd") == 4)
		{
			const f32 turnaroundspeed = 1.7f;
			const f32 normalspeed = 1.8f;
			const f32 backwardsspeed = 1.5f;
		}
		else if(blob.get_u8("spd") == 5)
		{
			const f32 turnaroundspeed = 1.8f;
			const f32 normalspeed = 2.0f;
			const f32 backwardsspeed = 1.6f;
		}
