...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	CBlob@ orb = server_CreateBlob("mat_wood", this.getTeamNum(), this.getPosition());
	if ( orb !is null)
	{
		orb.server_SetQuantity(15);
	}
...
void onCollision(CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point1)
{
	if (blob is null)
		return;
	//print("good");
	//if(blob.getTeamNum() != blob.getTeamNum())
	//{
		//print("bad");
		//Explode(this, 1000.0f, 4.0f);
	//}
