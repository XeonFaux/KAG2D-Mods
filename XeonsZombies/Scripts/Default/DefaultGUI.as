...
void LoadDefaultGUI()
{
    if(v_driver > 0)
    {
		...
		AddIconToken("$archerbot$", "ArcherBot.png", Vec2f(17, 18), 0);
		AddIconToken("$knightbot$", "KnightBot.png", Vec2f(17, 17), 0);
		AddIconToken("$megadrill$", "Mgdrll.png", Vec2f(32, 16), 0);
		AddIconToken("$megasaw$", "MegaSawicon.png", Vec2f(24, 16), 0);
		AddIconToken("$trader2$", "Trader2.png", Vec2f(40, 32), 0);
		AddIconToken("$nursery$", "Nursery.png", Vec2f(40, 32), 0);
		AddIconToken("$mat_molotov$", "Molotov.png", Vec2f(16, 16), 0);
		AddIconToken("$torch$", "Torch.png", Vec2f(8, 8), 0);
		AddIconToken("$mega_sponge$", "Megaspnge.png", Vec2f(21, 11), 1);
		AddIconToken("$divinghelmet$", "DivingHelmet.png", Vec2f(12, 14), 0);
		AddIconToken("$scrolluse$", "GUI/MenuItems.png", Vec2f(32, 32), 6);
		AddIconToken("$mageshop$", "MageShop.png", Vec2f(40, 32), 0);
    }
}
