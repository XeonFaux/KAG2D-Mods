...
const SColor color_random_scroll(0xffb0b07b);
const SColor color_random_tech(0xffe900f0);
...
class PNGLoader
{
	...
	if(pixel == color_tile_ground) {
		...
		else if(pixel == color_random_tech) {
			AddMarker( map, offset, "random tech" );
		}				
		else if(pixel == color_random_scroll) {
			AddMarker( map, offset, "random scroll" );
		}						
